...
const OurProcess = () => {
  return (
    <div className="flex flex-col relative ">
      <div className="absolute w-full min-h-[100dvh] h-full">
        <CustomImagePreview image={OurProcessImage} style="object-cover" />
      </div>
      <div className="z-20 flex flex-col items-center w-full h-full py-[100px] px-[25px] sm:px-[50px] md:px-[90px] xl:px-[125px]  gap-[49px]">
        <div className="flex flex-col gap-2 items-center">
          ...
          <div className="flex flex-col gap-3 items-center">
            ...
            <span className="text-xl text-common-white text-center max-w-[900px]">
              Our streamlined process ensures seamless service from consultation
              to installation. We design, install, and maintain your solar
              solution with care.
            </span>
          </div>
        </div>
        <div className="flex flex-col ">
          ...
          <div className="flex justify-between">
            <div className="flex flex-col gap-2.5 max-w-[350px] items-center">
              <span className="text-2xl font-bold text-common-white">
                Project Planning
              </span>
              <span className="text-xl text-common-white/80 text-center">
            ...
            <div className="flex flex-col gap-2.5 max-w-[350px] items-center">
              ...
              <span className="text-xl text-common-white/80 text-center">
                Professional solar installation with precision & care, ensuring
                optimal performance & long-term energy savings.
              </span>
            </div>
            <div className="flex flex-col gap-2.5 max-w-[350px] items-center">
              <span className="text-2xl font-bold text-common-white">
