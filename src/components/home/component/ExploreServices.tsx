...
const ExploreServices = () => {
  return (
    <div className="flex flex-col ">
      <div className="flex flex-col lg:flex-row px-[20px] sm:px-[40px] md:px-[70px] xl:px-[100px] py-7 justify-between bg-primaryText">
      ...
      <div className="flex flex-col relative">
        ...
        <div className="z-20 py-[100px] px-[25px] sm:px-[50px] md:px-[90px] xl:px-[125px] flex items-center flex-col w-full">
          ...
          <div className="flex flex-col  items-center">
            ...
            <span className="text-xl text-common-white max-w-[818px] mt-2 text-center">
              ...
              sustainable future is embedded in our name, and we strive to live
              up to our brand promise in everything we do.
            </span>
            <span className="w-[111px] border-b border-lightGreen mt-2"></span>
          </div>
          <div className="flex flex-col lg:flex-row gap-[46px] mt-10 ">
            <div className="flex flex-col gap-3 bg-common-white  p-4 max-w-[400px]">
              ...
              <div className="text-xl text-common-black">
                Raynex specializes in large-scale solar parks, allowing SMEs to
                invest like owning apartments.
              </div>
            ...
            <div className="flex flex-col gap-3 bg-common-white  p-4 max-w-[400px]">
              ...
              <div className="text-xl text-common-black">
                Our Solar Park Solutions provide clean, renewable energy to
