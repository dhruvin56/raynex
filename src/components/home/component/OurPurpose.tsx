...
const OurPurpose = () => {
  return (
    <div className="flex flex-col xl:flex-row py-[100px] px-[25px] sm:px-[50px] md:px-[90px] xl:px-[125px] gap-10 xl:gap-4 items-center">
      <div className="flex flex-col gap-[50px] items-center">
        ...
        <div className="flex flex-col gap-8">
          ...
          <span className="text-xl text-common-black text-center">
            ...
            brighter tomorrow. We’re committed to building a sustainable future
            for all by providing dependable & affordable solar solutions that
            empower individuals, businesses, and communities to make a lasting
            impact.
          </span>
        </div>
        <div>
