...
const WhySolarPower = () => {
  return (
    <div className="flex flex-col xl:flex-row py-[100px] px-[25px] sm:px-[50px] md:px-[90px] xl:px-[125px] gap-[50px] items-center">
      <div className="flex flex-col gap-10">
        <div className="flex flex-col gap-6">
          ...
          <div className="text-xl text-common-black max-w-[515px]">
            We deliver customized, high-performance solar solutions that reduce
            energy costs and promote sustainability. Our expert team ensures
            reliable installations with top-quality products, offering lasting
      ...
      <div className="flex flex-col lg:flex-row gap-5 ">
        <div className="flex flex-col gap-5 pt-10">
          <div className="flex flex-col p-7 gap-[18px] drop-shadow-md max-w-[360px] items-center bg-common-white">
            ...
            <div className="text-base text-common-black text-center">
              Save up to 80% on your electricity bills with solar energy. Get a
              free quote today & start enjoying clean, affordable power!
            </div>
          </div>
          <div className="flex flex-col p-7 gap-[18px] drop-shadow-md max-w-[360px] items-center bg-common-white">
            <div className="scale-90">
        ...
        <div className="flex flex-col gap-5 relative">
          <div className="flex flex-col p-7 gap-[18px] drop-shadow-md max-w-[360px] items-center bg-common-white">
            ...
            <div className="text-base text-common-black text-center">
              Recover your investment in just 4-7 years with our solar
          ...
          <div className="flex flex-col p-7 gap-[18px] drop-shadow-md max-w-[360px] items-center bg-common-white z-10">
            ...
            <div className="text-base text-common-black text-center">
              Grid tariffs rise by 3-5% annually, driving up electricity costs.
              Switch to solar and shield yourself from these hikes!
            </div>
          </div>
